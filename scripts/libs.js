...
setDocument = Sizzle.setDocument = function( node ) {
	...
	function( a, b ) {
		...
		return i ?
			// Do a sibling check if the nodes have a _common ancestor
		...
		if ( !arguments.length ) {
			if ( elem ) {
				...
				return typeof ret === "string" ?
					...
					// Handle most _common string cases
					ret.replace( rreturn, "" ) :
...
// Attach a bunch of functions for handling _common AJAX events
jQuery.each( [
	"ajaxStart",
	"ajaxStop",
	"ajaxComplete",
...
(function(){
    scrolltotop={
        ...
        controlHTML: '<div><i class="fa fa-angle-up"></i></div>', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
...
$.fn.extend({
 ...
 //     */
    ...
    var anime_dir=animeSetting.anime_dir?animeSetting.anime_dir:"left";    //动画的方向
    var path=animeSetting.path?animeSetting.path:[100,100];
